...
const navigationItems = [
  ...
  {
    titleKey: "nav.anomalyList",
    href: "/list",
    icon: List,
  },
  {
    titleKey: "nav.anomalyUpload",
    href: "/anomaly-upload",
    icon: Upload,
  },
  {
    titleKey: "nav.maintenanceWindows",
      ...
      <div className="p-2 border-b border-border ">
        <div className="flex flex-col items-center gap-3 relative">
          ...
          <div className="  ">
            ...
            <p className="text-xs text-muted-foreground">Anomaly Management</p>
          </div>
        </div>
      </div>
          ...
          {user?.role === "admin" && (
            <>
              ...
              <Link
                to="/admin"
                onClick={() => setIsMobileMenuOpen(false)}
                className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors bg-red-600 text-white hover:bg-red-700"
              >
